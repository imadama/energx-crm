...
<div class="blok-2kolommen" style="display:flex;align-items:stretch;">
  <div class="kolom" :style="'width:' + (element.inhoud.kolom1_breedte_pct ?? 50) + '%;padding-right:8px;'">
    ...
    <div x-show="activeElementId !== element.id" style="min-height:40px;">
      <div x-html="element.inhoud.kolom1_html || ''"></div>
    </div>
    ...
    <div x-show="activeElementId === element.id" style="display:none">
      <div :id="'quill-' + element.id + '-k1'" class="quill-veld"
           x-effect="
             const el = window.document.getElementById('quill-' + element.id + '-k1');
             if (el && !el._quill) {
  ...
  <div class="kolom" :style="'width:' + (100 - (element.inhoud.kolom1_breedte_pct ?? 50)) + '%;padding-left:8px;'">
    {{-- View mode (inactive) --}}
    <div x-show="activeElementId !== element.id" style="min-height:40px;">
      <div x-html="element.inhoud.kolom2_html || ''"></div>
    </div>
    ...
    <div x-show="activeElementId === element.id" style="display:none">
      <div :id="'quill-' + element.id + '-k2'" class="quill-veld"
           x-effect="
             const el = window.document.getElementById('quill-' + element.id + '-k2');
             if (el && !el._quill) {
