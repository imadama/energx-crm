...
<body>
  ...
  <aside class="sidebar">
    ...
    <nav class="sidebar-nav">
      ...
      <a href="{{ route('offertes.index') }}" class="nav-item {{ request()->routeIs('offertes.*') && !request()->routeIs('offerte-templates.*') ? 'active' : '' }}">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
      ...
      <a href="{{ route('aanvragen.index') }}" class="nav-item {{ request()->routeIs('aanvragen.*') ? 'active' : '' }}">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
      ...
      <a href="{{ route('offerte-templates.index') }}" class="nav-item {{ request()->routeIs('offerte-templates.*') ? 'active' : '' }}">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
      ...
      <a href="{{ route('api-fields.index') }}" class="nav-item {{ request()->routeIs('api-fields.*') ? 'active' : '' }}">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
